...
public class RoomController {
    ...
    @PreAuthorize("hasAuthority('ACADEMIC_SETUP_MANAGE')")
    public ApiResponse<RoomResponse> updateStatus(@PathVariable UUID id, @Valid @RequestBody ActiveStatusRequest request) {
        return ApiResponse.success("Room status updated", roomService.updateStatus(id, request.status()));
    }
}
